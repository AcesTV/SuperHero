                ...
                <form method="post" action="CreateIncident">
                    <fieldset>
                        ...
                        <ul class="CenterText">
                            ...
                            <li>
                                <input type="text" placeholder="Nom de la ville" id="CityHero" name="CityHero" value="<c:if test="${ !empty CityHero }"><c:out value="${ CityHero }"></c:out></c:if>"/>
                                <input type="hidden" id="CityHeroLat" name="CityHeroLat" value="<c:if test="${ !empty CityHeroLat }"><c:out value="${ CityHeroLat }"></c:out></c:if>"/>
                                <input type="hidden" id="CityHeroLong" name="CityHeroLong" value="<c:if test="${ !empty CityHeroLong }"><c:out value="${ CityHeroLong }"></c:out></c:if>"/>
                            </li>
                        </ul>
