                ...
                <fieldset>
                    ...
                    <fieldset>
                        ...
                        <ul class="CenterText">
                            ...
                            <li>
                                <input type="text" placeholder="Nom du héro" id="NameHero" name="NameHero"/>
                            </li>
                        </ul>
                        ...
                        <ul class="CenterText">
                            ...
                            <li>
                                <input type="text" placeholder="Numéro de téléphone" id="PhoneHero" name="PhoneHero"/>
                            </li>
                        </ul>
                        ...
                        <ul class="CenterText">
                            ...
                            <li>
                                <input type="text" placeholder="Votre ville" id="CityHero" name="CityHero"/>
                                <input type="hidden" id="CityHeroLat" name="CityHeroLat"/>
                                <input type="hidden" id="CityHeroLong" name="CityHeroLong"/>
                            </li>
                        </ul>
                    ...
                    <fieldset>
                        ...
                        <ul class="CenterText">
                            ...
                            <li>
                                <input type="text" placeholder="Mot de passe" id="PasswordHero" name="PasswordHero" type="password"/>
                            </li>
                        </ul>
                        ...
                        <ul class="CenterText">
                            ...
                            <li>
                                <input type="text" placeholder="Confirmer le mot de passe" id="PasswordCheckHero" name="PasswordCheckHero" type="password"/>
                            </li>
                        </ul>
