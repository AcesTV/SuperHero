            ...
            <form method="post" action="Login">
                <fieldset>
                    ...
                    <ul class="CenterText">
                        ...
                        <li>
                            <input type="text" placeholder="Nom du héro" id="NameHero" name="NameHero" value="<c:if test="${ !empty NameHero }"><c:out value="${ NameHero }"></c:out></c:if>">
                        </li>
                    </ul>
                    ...
                    <ul class="CenterText">
                        ...
                        <li>
                            <input type="text" placeholder="Mot de passe" type="password" id="PasswordHero" name="PasswordHero"/>
                        </li>
                    </ul>
